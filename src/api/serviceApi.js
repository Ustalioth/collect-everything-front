...
const serviceApi = {
    ...
    getOrdersByCustomerId: (customerId) => instance.get(`${API_BASE_URI}/order/all/customer/${customerId}`),
    getOrdersByStoreId: (storeId) => instance.get(`${API_BASE_URI}/order/all/store/${storeId}`),
